    ...
    switch(event.type){
      ...
      $ case SDL_KEYDOWN:
        ...
        switch(event.key.keysym.sym){
          ...
          $ case SDLK_j:
            simulation->player_table[0].entity.transform.rot.z += 0.1f;

            if(simulation->player_table[0].entity.transform.rot.z >  1.55)
              simulation->player_table[0].entity.transform.rot.z  = 1.55f;
          $ case SDLK_k:
            simulation->player_table[0].entity.transform.rot.z -= 0.1f;
