...
int init_tframe(tframe_t *frame){
    ...
    frame->set.h = bind_method(frame, set_frame_heigth);
    frame->set.w = bind_method(frame, set_frame_width);
    frame->set.max_h = bind_method(frame, set_frame_max_heigth);
    frame->set.max_w = bind_method(frame, set_frame_max_width);
    frame->set.min_h = bind_method(frame, set_frame_min_heigth);
    frame->set.min_w = bind_method(frame, set_frame_min_width);
    frame->con.max_h = 0;
    frame->con.max_w = 0;
    frame->dim.r = 0;
    frame->dim.c = 0;
...
int init_tui(term_w_t *terminal){
    ...
    terminal->io_block = bind_method(terminal, io_blocking_handler);
    terminal->cursor = bind_method(terminal, cursor_handler);
    terminal->horz_strdisp = bind_method(terminal, horz_strdisp);
    terminal->vert_strdisp = bind_method(terminal, vert_strdisp);
    terminal->horz_tiledisp = bind_method(terminal, horz_tiledisp);
    terminal->vert_tiledisp = bind_method(terminal, vert_tiledisp);
    terminal->draw_rect = bind_method(terminal, draw_rect);
    terminal->draw_border = bind_method(terminal, draw_border);
    terminal->draw_frame = bind_method(terminal, draw_frame);
